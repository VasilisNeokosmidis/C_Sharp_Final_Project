...
{
    public partial class Sights_Form : Beaches_Form
    {

        protected override int ItemsCount => AppList_Manager.List_Sights.Count;
        protected override string GetTitle(int i) => AppList_Manager.List_Sights[i].Title;
        protected override string GetDescription(int i) => AppList_Manager.List_Sights[i].Description;
        protected override List<byte[]> GetImages(int i) => AppList_Manager.List_Sights[i].Images;
        protected override IEnumerable<string> GetAllTitles()=> AppList_Manager.List_Sights.Select(s => s.Title);
        ...
        public Sights_Form(SessionContext session) : base(session)
        {
            InitializeComponent();
        }
