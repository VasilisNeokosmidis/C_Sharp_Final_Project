namespace Peripatos_UI
{
    partial class Base_Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            registerToolStripMenuItem.Text = "�������";
            ...
            clearHistoryToolStripMenuItem.Text = "���������� ���������";
            ...
            showHelpToolStripMenuItem.Text = "������ ������";
